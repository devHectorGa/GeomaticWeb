...
{GEOMATIC WEB}\\[6.0cm]
\Large\textbf{Hector Ferney Garz\'{o}n Cagua}\\[6.0cm]
...
Título de la tesis  o trabajo de investigación}\\[3.0cm]
\Large\textbf{Nombres y apellidos completos del autor}\\[3.0cm]
\small Tesis o trabajo de grado presentada(o) como requisito parcial para optar al
t\'{\i}tulo de:\\
\textbf{Indicar el título que se obtendrá. Por ejemplo, Magister en Ingenier\'{\i}a Qu\'{\i}mica}\\[2.5cm]
Director(a):\\
